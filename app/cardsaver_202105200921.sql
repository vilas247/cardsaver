...
--
-- Drop table `cardstream_scripts`
--
DROP TABLE IF EXISTS cardstream_scripts;

--
-- Drop table `cardstream_token_validation`
--
DROP TABLE IF EXISTS cardstream_token_validation;

--
-- Drop table `custom_cardstreampay_button`
--
DROP TABLE IF EXISTS custom_cardstreampay_button;
...
--
-- Create table `custom_cardstreampay_button`
--
CREATE TABLE custom_cardstreampay_button (
  id INT(11) NOT NULL AUTO_INCREMENT,
  email_id VARCHAR(255) NOT NULL,
...
--
-- Create table `cardstream_token_validation`
--
CREATE TABLE cardstream_token_validation (
...
--
-- Create table `cardstream_scripts`
--
CREATE TABLE cardstream_scripts (
