			...
			function loadCardstreamStatus(){
				...
				if(key != "undefined" && key != ""){
					$.ajax({
						...
						dataType: "json",
						crossDomain: true,
						url: "https://magento-commerce-blueprint.247commerce.co.uk/cardsaver/cardsaverpay/getPaymentStatus",
						dataType: "json",
						data:{"authKey":key},
										...
										success: function (cartres) {
											...
											if(bstatus ==0 && sstatus == 0) {
												...
												$.ajax({
													...
													dataType: "json",
													crossDomain: true,
													url: "https://magento-commerce-blueprint.247commerce.co.uk/cardsaver/cardsaverpay/authentication",
													dataType: "json",
